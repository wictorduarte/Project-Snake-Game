...
let viewControllers = getElementById("controllers");
    viewControllers.addEventListener("click", btnControllers);

function btnControllers(){
    alert('Press the arrows directionals to move the snake(up, down, left or right)');
    location.reload;
}
